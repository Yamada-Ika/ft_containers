...
// constructor
// (1)
TEST(MapTest, int_basic_constructor_1) { ft::map<int, int> mymp; }

// (2)
TEST(MapTest, int_basic_constructor_2) {
...
// (3)
TEST(MapTest, int_basic_constructor_3) {
  ft::greater<int> ftcomp;
  std::allocator<int> ftalloc;
...
// (4)
TEST(MapTest, int_basic_constructor_4) {
...
// destructor
TEST(MapTest, int_basic_destructor) {
  ft::map<int, int> mymp;
...
TEST(MapTest, int_basic_get_allocator_const) {
  ft::greater<int> mycomp;
  std::allocator<int> alloc;
...
TEST(MapTest, int_basic_at_const) {
  std::map<int, int> liborg;
...
TEST(MapTest, int_basic_begin_const) {
  std::map<int, int> liborg;
  liborg.insert(std::make_pair(1, 1));
  const std::map<int, int> libmp(liborg.begin(), liborg.end());
